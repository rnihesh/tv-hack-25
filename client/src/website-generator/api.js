      ...
      data: {
        ...
        website: {
          ...
          hero: {
            ...
            subheadline: "Professional services tailored to your business needs",
            callToAction: "Get Started Today"
          },
          about: {
            title: "About Us",
            content: "We are a leading company in our industry, providing exceptional services to our clients.",
            mission: "To deliver outstanding results and exceed customer expectations."
          },
          services: [
            {
              title: "Service 1",
    ...
    return {
      ...
      data: {
        ...
        pagination: {
          ...
          pages: Math.ceil(mockWebsites.length / (parseInt(params.limit) || 10))
        }
      }
    };
  },
      ...
      data: {
        website: {
          ...
          structure: {
            ...
            hero: { headline: "Sample Headline", subheadline: "Sample subheadline" }
          },
          customizations: {
            style: "modern",
            colorScheme: "blue"
