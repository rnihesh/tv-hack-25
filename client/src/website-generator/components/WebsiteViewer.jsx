...
const WebsiteViewer = ({ website, onUpdate, loading }) => {
  ...
  const renderWebsiteStructure = (structure) => {
    if (!structure) return <div className="text-gray-500">No website structure available</div>;
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="space-y-8">
        {editMode ? (
          ...
          <div>
            <h3 className="text-xl font-semibold text-gray-900 mb-6">Website Preview</h3>
