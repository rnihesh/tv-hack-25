  ...
  const fetchMessages = async () => {
    try {
      ...
      const filteredMessages = selectedTopic === "all" 
        ? allMessages 
        : allMessages.filter(msg => msg.topics && msg.topics.includes(selectedTopic));
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400">
              ...
              <span>{Array.isArray(messages) ? messages.length : 0} messages</span>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="lg:col-span-3">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden">
              ...
              <div className="h-96 overflow-y-auto p-6 space-y-4 bg-gray-50 dark:bg-gray-900/50">
                {(!Array.isArray(messages) || messages.length === 0) && !error ? (
                  ...
                  Array.isArray(messages) && messages.map((msg) => (
                    <div key={msg._id} className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-md transition-shadow duration-200">
                      <div className="flex items-start space-x-3">
                        <div className="w-10 h-10 bg-gradient-to-r from-violet-500 to-purple-600 rounded-full flex items-center justify-center text-white font-bold text-sm">
                          {(msg.author?.companyName || "U").charAt(0).toUpperCase()}
                        </div>
