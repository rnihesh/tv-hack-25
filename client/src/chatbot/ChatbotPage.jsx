...
const ChatbotPage = () => {
  ...
  useEffect(() => {
    ...
    setMessages([{
      id: 1,
      text: "Hello! I'm your AI business assistant. I have full context about your business and can help you with various tasks like answering customer questions, providing business insights, and helping with general inquiries. How can I assist you today?",
      isBot: true,
      timestamp: new Date()
    }]);
  }, []);
              ...
              <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">Context-aware business helper</p>
                  </div>
                </div>
                <button
                  onClick={clearChat}
